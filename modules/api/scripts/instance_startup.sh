...
docker run -d \
  ...
  -e META_APIVERSION_MAJOR='${API_VERSION_MAJOR}' \
  -e META_APIVERSION_MINOR='${API_VERSION_MINOR}' \
  -e META_APIVERSION_PATCH='${API_VERSION_PATCH}' \
  -e META_DATA_YEAR='${API_DATA_YEAR}' \
  -e META_DATA_MONTH='${API_DATA_MONTH}' \
  -e META_DATA_ITERATION='${API_DATA_ITER}' \
  -e PLATFORM_API_IGNORE_CACHE='true' \
